...
describe(`${PhotoFrameComponent.name}`, () => {
  ...
  multiple times whithin debounce time`, fakeAsync(() => {
  ...
  it(`(D) Should display number of likes when (@input likes) 'likes' is incremented`, () => {
    fixture.detectChanges();
    component.likes++;
    fixture.detectChanges();
  ...
  it(`(D) Should display image with src ands description when bound to properties`, () => {
